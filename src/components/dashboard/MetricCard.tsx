...
export const MetricCard = ({ title, value, icon, valueColor = 'text-primary' }: MetricCardProps) => {
  return (
    <div className="bg-card/90 backdrop-blur-[10px] border border-border shadow-eg-sm rounded-[20px] transition-all duration-300 hover:-translate-y-1 hover:shadow-eg-hover p-4 md:p-6 flex flex-col justify-between min-h-[140px] lg:col-span-1">
